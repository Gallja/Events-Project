...
<html lang = ita>
<head>
    <title>Modifica Musicista</title>
    ...
    <div class = "container d-flex align-items-center centrato">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="row justify-content-center align-items-center" id = "div_search">
                    <input id = "input_ricerca" class="form-control mr-sm-2" type="search" placeholder="Cerca campo" aria-label="Search">
        ...
        <?php
            if (isset($_POST['id'])) {
                ...
                if (!$res) {
                    echo "<h4>Errore nella visualizzazione del musicista da modificare.</h4>";
                } else {
                    ...
                    foreach ($row as $key => $value) {
                        ...
                        switch ($key) {
                            ...
                            case 'profilo_musicista':
                                ...
                                echo "<li class='"."list-group-item"."'>";
                                echo "FOTO ".strtoupper($campi_chiave[0])." ".strtoupper($campi_chiave[1]).": <br />";
                ...
                echo "<h3>Errore nella ricerca del musicista da rimuovere</h3><br>";
                echo "<form class = 'form-group' action = 'insert_musicista.php'>";
